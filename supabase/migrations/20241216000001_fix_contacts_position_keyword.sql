-- Fix the position keyword issue by recreating the contacts table
-- Drop the existing table and recreate it with proper quoting

-- Drop existing table and related objects
DROP TABLE IF EXISTS contacts CASCADE;

-- Create contacts table with proper quoting for reserved keywords
